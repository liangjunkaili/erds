...
function register(){
	...
	var v=$("#register_validateCode").val();
	 var data = "{'pid':"+e+",'pName':'"+l+"','pwd':'"+s+"','child':"+c+",'validateCode':"+v+"}";	 
	$.ajax({
		 url: "register_parent",
		 type: "POST",
		 data:'data='+data,
		 success: function(data){
			 if(data.code==100){
				 ...
				 if(confirm("注册成功!")){
					 window.location.href="login_parent.jsp";
				 }
			 }
		 },
		 dataType: "json"
		...
		<div class="login_box clearfix" id="register_box">
			...
			<div class="register_nickname">
				<input type="text" value="" id="child"
					class="account_number account_input" placeholder="孩子账号">
			</div>
			<div class="login_pwd">
			...
			<div class="login_hint clearfix register_hint">
				<a href="login_parent.jsp" class="float_right skip_login">已有账号，去登录></a>
			</div>
