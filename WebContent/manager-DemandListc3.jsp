...
<script type="text/javascript">
	...
	function init(pageIndex,pageSize) {
		$.ajax({
					url : "getMoreDemand",
					type : "POST",
					data : "type=c3&pageIndex="+pageIndex+"&pageSize="+pageSize,
						...
						if (data.code == 200) {
							...
							for (var i = 0; i < l; i++) {
								...
								courseList += "<tr><td>"
										...
										+ "'>添加课时</a>|<a href='delDemand?id="+obj.id+"'>删除</a></td><td><a href='manager-SubjectList.jsp?did="
										+ obj.id + "'>" + obj.state
										+ "</a></td></tr>";
							}
						}
	...
	$(function(){
		$("#nav-DemandListc3").addClass("active");
		init(1,1000);
	})
</script>
