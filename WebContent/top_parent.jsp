    ...
    <header id="J_siteNav" class="site-nav ">
        <nav class="site-nav-bd clearfix">
            <div class="account ">
				...
				%>
				 <a class="link account-login" href="login_parent.jsp">请登录</a>
                <a class="link account-register" href="register_parent.jsp" rel="nofollow">免费注册</a>
				<%
					} else {
				%>
				<a class="link account-login" href="myCourse_parent.jsp"><%=request.getSession().getAttribute("pName")%></a>
				<%
					}
				%>
            </div>
