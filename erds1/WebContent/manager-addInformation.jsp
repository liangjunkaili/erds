	...
	<div class="content container list_main clearfix">
		...
		<table class="table table-striped">
			...
			<tr>
				<td>链&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;接</td>
				<td>
				<input type="text" name="href"  placeholder="http://www.baidu.com">
				</td>
			</tr>
			<tr>
				<td><label>封 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;面</label></td>
				<td><input type="file" name="cover" placeholder="上传图片大小推荐：250*134"/></td>
			</tr>
			<tr>
...
$(function(){
	$("#nav-addInformation").addClass("active");
})
</script>
</body>
</html>
