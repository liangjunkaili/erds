...
e.errorTypes=["MEDIA_ERR_CUSTOM","MEDIA_ERR_ABORTED","MEDIA_ERR_NETWORK","MEDIA_ERR_DECODE","MEDIA_ERR_SRC_NOT_SUPPORTED","MEDIA_ERR_ENCRYPTED"],e.defaultMessages={1:"用户终止播放",2:"视频下载错误，请刷新页面重试",3:"浏览器不支持该视频格式",4:"网络或服务器问题，无法下载视频",5:"视频已加密，无法播放"};
...
"seekable",
"networkState",
"readyState"].forEach(function(a){_.prototype[a]=function(){return this.techGet_(a)}}),$.forEach(function(a){_.prototype["handleTech"+(0,B["default"])(a)+"_"]=function(){return this.trigger(a)}}),
...
for(var F=0;F<D.length;F++)j(D[F]);
...
this.remoteTextTrackEls().removeTrackElement_(c),this.remoteTextTracks().removeTrack_(b);for(var d=this.$$("track"),e=d.length;e--;)b!==d[e]&&b!==d[e].track||this.el().removeChild(d[e])},b}(m["default"]);
...
function d(a,b){return a="number"==typeof a||e.test(a)?+a:-1,b=null==b?f:b,a>-1&&a%1==0&&a<b}
