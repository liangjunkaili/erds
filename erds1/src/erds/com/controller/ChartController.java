...
public class ChartController {
	...
	@Frequency(name="getChart", limit=100, time=60)
	@RequestMapping("/getChart")
	@ResponseBody
	public JSONObject getChart(HttpServletRequest request) {
		...
		try {
	        ...
	        String chartURL=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+ "/chart?filename="+fileName;
	        obj.put("url", chartURL);
		} catch (Exception e) {
		}
		return obj;
	}
